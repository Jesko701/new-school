...
const AboutUsFooter = () => (
    <div className="w-full md:w-1/3 text-center md:text-left mb-6 md:mb-0">
        ...
        <p className="text-sm leading-relaxed">
            School that focusing on children's development, providing a safe and stimulating environment for young minds to learn and grow. We believe in nurturing creativity, curiosity, and a love for learning from an early age.
        </p>
    ...
    <div className="w-full md:w-1/3 text-center mb-6 md:mb-0">
        ...
        <ul className="text-sm space-y-2">
            {navLinks.map((link)=>{
                return (
                    <li key={link.label}>
                        <a href={link.href} className="hover:text-red-300">{link.label}</a>
                    </li>
                )
            })}
        </ul>
...
const ContactUsFooter = () => (
    <div className="w-full md:w-1/3 text-center md:text-right">
        ...
        <p className="text-sm">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, facere.<br />
            Lorem, ipsum dolor.<br />
            Email: Lorem ipsum dolor sit.<br />
            Phone: (123) 456-7890
        </p>
    </div>
);
